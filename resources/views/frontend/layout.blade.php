                        ...
                        <nav>
                            <ul>
                                ...
                                <li><a href="{{ url('products') }}">Products</a>
                                    <ul class="single-dropdown">
                                        <h4 class="categories-subtitle">Categories</h4>
                                        <li><a href={{ url('/products?category=meja') }}>Meja</a></li>
                                        <li><a href={{ url('/products?category=kursi') }}>Kursi</a></li>
                                        <li><a href={{ url('/products?category=lemari') }}>Lemari</a></li>
                                        <li><a href={{ url('/products?category=acc') }}>Accesories</a></li>
                                        <li><a href={{ route('carts.index') }}>shopping cart</a></li>
                                        <li><a href={{ url('wishlists') }}>Favorites</a></li>
                                    </ul>
                                </li>
                ...
                <div class="widget-wrapper">
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer-about-2">
                            <p>IsiRumah adalah sebuah Startup yang mempermudah <br> pengrajin Furniture untuk
                                mempermudah bisnisnya <br> melalui penjualan online.
                            </p>
                        </div>
                    </div>
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer-info-wrapper-3">
                            <div class="footer-address-furniture">
                                ...
                                <div class="footer-info-content3">
                                    <p>Kost Mandala Binus Anggrek<br>jl. Kebon Jeruk no.14</p>
                                </div>
                            </div>
                            <div class="footer-address-furniture">
                                <div class="footer-info-icon3">
                                ...
                                <div class="footer-info-content3">
                                    <p>+62 Nomor Lu<br>+62 Nomor Lu</p>
                                </div>
                            </div>
                            <div class="footer-address-furniture">
                                <div class="footer-info-icon3">
                                ...
                                <div class="footer-info-content3">
                                    <p><a href="#"> Email Kamu</a> <br><a href="#">
                                            Email Perusahaan</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="copyright-furniture">
                            <p>Copyright © <a href="https://hastech.company/">Arnold Pramudita</a> 2023 . All Right
                                Reserved.
                            </p>
                        </div>
                    </div>
